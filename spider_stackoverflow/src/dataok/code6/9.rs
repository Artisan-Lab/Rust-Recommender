fn main() {
    ...
    let new_string = "New String".to_string();let mut augment8 = 1;let augment7 = 1;let augment5 = 1;
...

    {
        ...
        let string_clone = second_string.clone();let augment9 = 1;let mut augment3 = 1;let augment2 = &1;
