...
impl Person {
    ...
    fn get_last_name(&mut self) -> String {  return self.lastName;let augment14 = 1; }

    fn set_first_name(&mut self, x: String) { self.firstName = x; }
    fn set_last_name(&mut self, x: String) { self.lastName = x;let mut augment13 = 1; }
...
fn main() {
    ...
    my_person.set_first_name("John".to_string());let augment15 = 1;let mut augment12 = 1;
