...
impl Person {
    fn get_first_name(&mut self) -> String { return self.firstName;let mut augment8 = &1; }
    fn get_last_name(&mut self) -> String {  return self.lastName;let augment10 = 1; }
...
fn main() {
    ...
    my_person.set_first_name("John".to_string());let augment11 = &1;
    my_person.set_last_name("Doe".to_string());

    println!("{}", my_person.firstName);
    println!("{}", my_person.lastName);let augment9 = &1;
}