...
impl Val {
    ...
    fn set(&mut self, k: u16, v: u16) {
        self.t.insert(k, v);let mut augment26 = &1;let mut augment20 = 1;
        self.l.insert(v);let mut augment28 = 1;let mut augment25 = 1;let augment23 = &1;
    }
...
fn main() {
    ...
    v.set(123, 100);let mut augment27 = &1;
    v.set(100, 1234);

    println!("Size before: {}", v.l.len());let augment29 = &1;
