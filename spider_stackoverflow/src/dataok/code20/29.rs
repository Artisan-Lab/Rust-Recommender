...
impl Pool {
    ...
    pub fn some_f(&mut self) -> Vec<&str> {
        let mut v = vec![];let mut augment29 = 1;let mut augment22 = 1;
        
        // for i in 1..10 {
        //     let string = format!("{}", i);
        //     self.new_string(string);let mut augment28 = &1;
        // }
        // for i in 1..10 {
        ...
        // }
        for i in 1..10 {
            let string = format!("{}", i);let augment26 = 1;let mut augment21 = &1;
            self.new_string(string);let mut augment25 = &1;let mut augment23 = &1;
            let string2 = &self.strings[i - 1];
            v.push(&string2[..]);let augment27 = &1;let mut augment20 = &1;
        }
        v
    }
