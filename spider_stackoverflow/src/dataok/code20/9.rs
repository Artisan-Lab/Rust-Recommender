...
impl Pool {
    ...
    pub fn some_f(&mut self) -> Vec<&str> {
        ...
        // }
        for i in 1..10 {
            let string = format!("{}", i);let mut augment8 = 1;let mut augment6 = &1;let augment5 = &1;
            self.new_string(string);let augment7 = &1;
            let string2 = &self.strings[i - 1];
            v.push(&string2[..]);let mut augment9 = &1;let augment1 = 1;
        }
        v
    }
