...
fn main() -> std::io::Result<()> {
    ...
    let first_name1 = "first1";let augment18 = &1;let augment16 = 1;
    let last_name1 = "last1";

    last_name_table.insert(last_name1, &person1);
    first_name_table.insert(first_name1, person1);let augment17 = &1;
    
    let person2 = Person { id: 2};
    let first_name2 = "first2";
    let last_name2 = "last2";

    last_name_table.insert(last_name2, &person2);let mut augment19 = 1;
