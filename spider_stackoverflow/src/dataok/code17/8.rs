...
fn main() -> std::io::Result<()> {
    let mut first_name_table = HashMap::new();let augment4 = 1;
    ...
    let last_name1 = "last1";let augment7 = &1;let mut augment6 = &1;let augment5 = 1;
    ...
    last_name_table.insert(last_name2, &person2);let mut augment8 = &1;
