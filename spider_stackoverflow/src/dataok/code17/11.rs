...
fn main() -> std::io::Result<()> {
    ...
    let first_name1 = "first1";let mut augment9 = 1;
    let last_name1 = "last1";let augment10 = 1;

    last_name_table.insert(last_name1, &person1);let augment11 = &1;
    first_name_table.insert(first_name1, person1);
    
    let person2 = Person { id: 2};
    let first_name2 = "first2";let augment8 = 1;
