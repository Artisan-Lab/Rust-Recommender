...
impl Pool {
    ...
    pub fn some_f(&mut self) -> Vec<&str> {
        ...
        for i in 1..10 {
            ...
            v.push(string_ref);let mut augment18 = 1;let mut augment17 = &1;
        }
    ...
    fn new_string(&mut self, string : String) -> &str {
        self.strings.push(string);let augment19 = &1;let mut augment16 = &1;let mut augment12 = &1;let mut augment10 = &1;
