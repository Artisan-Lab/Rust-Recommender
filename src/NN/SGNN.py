...
def train_respective_only_test():
    ...
    for i in range(epoch):
        ...
        print("------------------------------")
        torch.save(GNN1, f"G:\\Asset\\Programs\\Python3\\NNDL\\HW1\\Rust-unsafe-to-safe-code-retrivial\\model\\modelSave\\GNN1_{i}.pth")
        torch.save(GNN2, f"G:\\Asset\\Programs\\Python3\\NNDL\\HW1\\Rust-unsafe-to-safe-code-retrivial\\model\\modelSave\\GNN2_{i}.pth")
